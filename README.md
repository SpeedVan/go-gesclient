...
Ported code is released under the [MIT](https://github.com/SpeedVan/go-gesclient/blob/master/LICENSE) license.
...
1. Install using `go get -u github.com/SpeedVan/go-gesclient`.
